...
```bash
npm test           # 281 checks: unit, metrics, writes, end-to-end, security
```
...
| **Tests** | 38 unit · 26 metric · 41 write-layer · 98 end-to-end · 68 security · 10 smoke = **281 checks**, plus five static guards (money, routes, migrations, docs, types) |
...
npm run test           # 281 checks across five suites
