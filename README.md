...
```bash
npm test           # 294 checks: unit, metrics, writes, end-to-end, security
```
...
| **Tests** | 51 unit · 26 metric · 41 write-layer · 98 end-to-end · 68 security · 10 smoke = **294 checks**, plus five static guards (money, routes, migrations, docs, types) |
...
npm run test           # 294 checks across five suites
